...
export function MainLand() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>Mainland Company Setup in Dubai – RDV Consultants</title>
        <meta name="description" content="Set up your mainland company in Dubai with RDV Consultants. 100% foreign ownership, full market access, and expert business setup guidance in the UAE." />
        <meta name="keywords" content="Mainland company setup Dubai, Mainland business UAE, Company formation Dubai, Business setup consultants, 100% foreign ownership UAE, Dubai business license, Top company formation in uae, Best company set up in uae" />
        <meta property="og:title" content="Mainland Company Setup in Dubai – RDV Consultants" />
        <meta property="og:description" content="Set up your mainland company in Dubai with RDV Consultants. 100% foreign ownership, full market access, and expert business setup guidance in the UAE." />
        <meta property="og:image" content="/images/favicon-r-orange.png" />
        <meta property="og:url" content="https://rdv.ae/mainland" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Mainland Company Setup in Dubai – RDV Consultants" />
        <meta name="twitter:description" content="Set up your mainland company in Dubai with RDV Consultants. 100% foreign ownership, full market access, and expert business setup guidance in the UAE." />
          ...
          <div className="container mx-auto px-4 max-w-7xl h-full flex flex-col justify-center -mt-16">
            <div className="max-w-3xl">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 italic">
                Your Gateway to 100% Business Ownership in Dubai
              </p>
              <button
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">
              Mainland Company Setup in Dubai: Your Path to Business Success
            </h2>
            <p className="text-gray-600 mb-8">
              Looking for expert mainland company formation in Dubai? RDV Consultants specializes in mainland company setup in the UAE, offering comprehensive business setup services in Dubai. Our team of experienced business setup consultants in Dubai will guide you through every step of the mainland company formation process.
            </p>
            <p className="text-gray-600">
              Whether you're planning to start a mainland company in Dubai or expand your existing business, our business setup consultants in Dubai provide tailored solutions for mainland company formation in the UAE. We ensure a smooth and efficient mainland company setup process, helping you establish your presence in Dubai's thriving business landscape.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#0f172a]">
        <div className="container mx-auto px-4 max-w-7xl">
          <motion.div 
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-3xl font-bold text-white mb-4">Frequently Asked Questions About Mainland Company Formation in Dubai</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {[
              {
                question: "What are the benefits of mainland company formation in Dubai?",
                answer: "Mainland company formation in Dubai offers several advantages, including 100% business ownership, the ability to trade directly with the local market, and access to government contracts. Our business setup consultants in Dubai can help you understand all the benefits of mainland company setup in the UAE."
              },
              {
                question: "How long does mainland company formation in Dubai take?",
                answer: "The mainland company formation process in Dubai typically takes 2-4 weeks, depending on the business activity and required approvals. Our business setup consultants in Dubai will guide you through each step of the mainland company setup process."
              },
              {
                question: "What documents are needed for mainland company formation in Dubai?",
                answer: "For mainland company formation in Dubai, you'll need passport copies, visa copies, business plan, and other relevant documents. Our business setup consultants in Dubai will provide a complete checklist for mainland company setup in the UAE."
              },
              {
                question: "Can foreigners own 100% of a mainland company in Dubai?",
                answer: "Yes, with the recent changes in UAE law, foreigners can now own 100% of mainland companies in Dubai. Our business setup consultants in Dubai can help you understand the requirements for 100% ownership in mainland company formation."
              }
            ].map((faq, index) => (
              <div 
                key={index}
