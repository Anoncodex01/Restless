...
export function FreeZone() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>Free Zone Company Setup in UAE – RDV Consultants</title>
        <meta name="description" content="Establish your business in a UAE Free Zone with RDV Consultants. Enjoy 100% foreign ownership, tax benefits, and fast company formation." />
        <meta name="keywords" content="Free zone company setup UAE, Free zone business Dubai, Free zone registration, Business setup consultants, Tax free company UAE, Free zone license, Free zone benefits UAE, Free zone registration consultants" />
        <meta property="og:title" content="Free Zone Company Setup in UAE – RDV Consultants" />
        <meta property="og:description" content="Establish your business in a UAE Free Zone with RDV Consultants. Enjoy 100% foreign ownership, tax benefits, and fast company formation." />
        <meta property="og:image" content="/images/favicon-r-orange.png" />
        <meta property="og:url" content="https://rdv.ae/freezone" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Free Zone Company Setup in UAE – RDV Consultants" />
        <meta name="twitter:description" content="Establish your business in a UAE Free Zone with RDV Consultants. Enjoy 100% foreign ownership, tax benefits, and fast company formation." />
          ...
          <div className="container mx-auto px-4 max-w-7xl h-full flex flex-col justify-center -mt-16">
            <div className="max-w-3xl">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 italic">
                Your Gateway to Tax-Free Business in Dubai Free Zones
              </p>
              <button
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">
              Free Zone Company Setup in Dubai: Your Path to Business Success
            </h2>
            <p className="text-gray-600 mb-8">
              Looking for expert free zone company formation in Dubai? RDV Consultants specializes in free zone company setup in the UAE, offering comprehensive business setup services in Dubai's free zones. Our team of experienced business setup consultants in Dubai will guide you through every step of the free zone company formation process.
            </p>
            <p className="text-gray-600">
              Whether you're planning to start a free zone company in Dubai or expand your existing business, our business setup consultants in Dubai provide tailored solutions for free zone company formation in the UAE. We ensure a smooth and efficient free zone company setup process, helping you establish your presence in Dubai's thriving free zone business landscape.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#0f172a]">
        <div className="container mx-auto px-4 max-w-7xl">
          <motion.div 
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-3xl font-bold text-white mb-4">Frequently Asked Questions About Free Zone Company Formation in Dubai</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {[
              {
                question: "What are the benefits of free zone company formation in Dubai?",
                answer: "Free zone company formation in Dubai offers several advantages, including 100% foreign ownership, tax exemptions, and simplified business setup procedures. Our business setup consultants in Dubai can help you understand all the benefits of free zone company setup in the UAE."
              },
              {
                question: "How long does free zone company formation in Dubai take?",
                answer: "The free zone company formation process in Dubai typically takes 1-2 weeks, depending on the chosen free zone and business activity. Our business setup consultants in Dubai will guide you through each step of the free zone company setup process."
              },
              {
                question: "What documents are needed for free zone company formation in Dubai?",
                answer: "For free zone company formation in Dubai, you'll need passport copies, visa copies, business plan, and other relevant documents. Our business setup consultants in Dubai will provide a complete checklist for free zone company setup in the UAE."
              },
              {
                question: "Can I trade with the local market from a free zone company in Dubai?",
                answer: "While free zone companies in Dubai can conduct international business, trading with the local UAE market requires additional setup. Our business setup consultants in Dubai can help you understand the requirements for local market access."
              }
            ].map((faq, index) => (
              <div 
                key={index}
